...
public class AuthorizedClientsController {
    ...
    @GetMapping("/oauth2/authorized-clients") // url custom, nao é padrao
    ...
    @PostMapping("/oauth2/authorized-clients/revoke") // 27.21
    public String revoke(Principal principal, Model model, @RequestParam(OAuth2ParameterNames.CLIENT_ID) String clientId){
        ...
        return "redirect:/oauth2/authorized-clients"; // chama o @Get acima novamente
    }
}
