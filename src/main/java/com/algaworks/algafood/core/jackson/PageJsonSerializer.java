...
@JsonComponent
public class PageJsonSerializer extends JsonSerializer<Page<?>> { //manipular o objecto json serializado pelo Page (objs content e pageable)
    ...
    public void serialize(Page<?> page, JsonGenerator gen, SerializerProvider serializerProvider) throws IOException {
        ...
        gen.writeObjectField("descricao", "Editado pela nossa classe PageJsonSerializer");
