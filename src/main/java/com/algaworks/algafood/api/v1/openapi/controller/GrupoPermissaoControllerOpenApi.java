...
public interface GrupoPermissaoControllerOpenApi {
    ...
    public CollectionModel<PermissaoModel> listar(@Parameter(description = "ID de um grupo de usuarios", example = "1", required = true) Long grupoId);
    ...
    public ResponseEntity<Void> associar(@Parameter(description = "ID de um grupo de usuarios", example = "1", required = true) Long grupoId, @Parameter(description = "ID de uma permissão", example = "1", required = true) Long permissaoId);
    ...
    public ResponseEntity<Void> desassociar(@Parameter(description = "ID de um grupo de usuarios", example = "1", required = true) Long grupoId, @Parameter(description = "ID de uma permissão", example = "1", required = true) Long permissaoId);
}
